...
const RegisterPatient = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'phone_number') {
      const numericValue = value.replace(/[^0-9+]/g, ''); // Remove non-numeric and non-plus characters
      setFormData((prevData) => ({
        ...prevData,
        [name]: numericValue
      }));
  ...
  if (!phoneRegex.test(phone_number)) {
    toast.error('Phone number should be in the format +1234567890 or 1234567890.');
    return false;
  }
